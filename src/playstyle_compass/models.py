...
class Game(models.Model):
    ...
    developers = models.CharField(max_length=100, blank=True, null=True)
    game_images = models.TextField(blank=True, null=True)
    similar_games = models.CharField(max_length=200, blank=True, null=True)
    dlcs = models.CharField(max_length=200, blank=True, null=True)
    franchises = models.CharField(max_length=200, blank=True, null=True)
...
class Character(models.Model):
    ...
    image = models.TextField(blank=True, null=True)
    images = models.TextField(blank=True, null=True)
    character_id = models.IntegerField(default=0, blank=True, null=True)
...
class News(models.Model):
    ...
    id = models.BigAutoField(primary_key=True)
    article_id = models.CharField(max_length=50, unique=True, blank=True, null=True)
    title = models.CharField(max_length=255)

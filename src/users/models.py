...
class UserProfile(models.Model):
    ...
    bio = models.TextField(max_length=50, null=True, default="")
    favorite_game = models.CharField(max_length=50, null=True, default="")
    favorite_character = models.CharField(max_length=50, null=True, default="")
    gaming_commitment = models.CharField(max_length=50, default="")
    main_gaming_platform = models.CharField(max_length=50, default="")
    ...
    current_game = models.CharField(max_length=50, null=True, default="")
    favorite_soundtrack = models.CharField(max_length=50, null=True, default="")
    gaming_alias = models.CharField(max_length=50, null=True, default="")
    favorite_game_modes = models.CharField(max_length=50, default="")
